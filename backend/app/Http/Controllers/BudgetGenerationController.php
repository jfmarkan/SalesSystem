...
public function generate(Request $request)
{
    ...
    foreach ($cpcIds as $cpcId) {
        ...
        // ✅ Nuevo: ignorar CPC si tiene skip_budget=true
	...
	// A, B, PA, PB → leer valores guardados, no forecast
	if (in_array($classId, [1, 2, 6, 7], true)) {
		...
		return [$best, $worst, false]; // no forecast
	}

	// C y D → usar input del request, forecast = true
	if ($classId === 3) {
