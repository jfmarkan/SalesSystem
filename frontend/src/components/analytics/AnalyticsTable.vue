			...
			<table class="w-full" style="min-width: 1200px; border-collapse: separate; border-spacing: 0">
				<thead>
					<tr>
						...
						<th v-for="(m, i) in months" :key="m" class="p-2 text-center stick-head" :class="{
							'cur-left': i === curIdx,
							'cur-right': i === curIdx,
							'cur-top': i === curIdx,
						}">
				...
				<tbody>
					...
					<tr>
						...
						<td v-for="(m, i) in months" :key="'v' + m" class="p-2 text-center cell cell-sales text-strong"
					...
					<tr>
						...
						<td v-for="(m, i) in months" :key="'b' + m" class="p-2 text-center cell cell-budget text-strong"
							:class="{ 'cur-left': i === curIdx, 'cur-right': i === curIdx }">
							{{ fmt0(normBudget[i] ?? 0) }}
						</td>
					</tr>
					...
					<tr>
						...
						<td v-for="(m, i) in months" :key="'f' + m" class="p-2 text-center cell text-strong" :class="{
							'cur-left': i === curIdx,
							'cur-right': i === curIdx,
							'cur-bottom': i === curIdx,
						}">
					...
					<tr>
						...
						<td v-for="(m, i) in months" :key="'ivb' + m" class="p-2 text-center cell dev-cell" :class="[
					...
					<tr>
						...
						<td v-for="(m, i) in months" :key="'ifb' + m" class="p-2 text-center cell dev-cell" :class="[
